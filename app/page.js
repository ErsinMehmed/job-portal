      ...
      <div className="bg-[#f3f7fd] w-full">
        <div className="lg:flex items-center px-10 lg:px-12 xl:px-14 2xl:px-0 w-full max-w-screen-2xl mx-auto pb-16 lg:pb-0 pt-20 lg:pt-12 space-x-10">
          <div className="w-full lg:w-7/12">
            ...
            <div className="lg:bg-white lg:p-5 lg:shadow lg:border border-slate-200 rounded-lg lg:flex items-center lg:space-x-3 mt-8 space-y-5 lg:space-y-0">
              <div className="flex items-center w-full">
                <div className="bg-white lg:bg-transparent py-5 lg:py-0 rounded-l-lg pl-4 lg:pl-0 border border-gray-200 border-r-0 lg:border-0">
                ...
                <input
                  ...
                  className="text-gray-700 text-sm focus:outline-none w-full px-2.5 pl-4 lg:pl-2.5 py-6 lg:py-2.5 bg-white bg-white border border-gray-200 border-l-0 lg:border-0 rounded-r-lg"
                />
              </div>

              <div className="flex items-center w-full lg:border-l-2 lg:pl-2.5">
                <div className="bg-white lg:bg-transparent py-[17px] lg:py-0 rounded-l-lg pl-4 lg:pl-0 border border-gray-200 border-r-0 lg:border-0">
                ...
                <input
                  ...
                  className="text-gray-700 text-sm focus:outline-none w-full px-2.5 pl-4 lg:pl-2.5 py-6 lg:py-2.5 bg-white border border-gray-200 border-l-0 lg:border-0 rounded-r-lg"
                />
              </div>
          ...
          <div className="hidden lg:block w-5/12 relative">
            <div className="absolute top-4 xl:top-10 xl:-left-36 -left-24 bg-white p-3 xl:p-4 rounded-xl shadow-md border border-slate-100 flex items-center space-x-4 w-56 xl:w-72">
            ...
            <div className="absolute top-20 -right-16 bg-white p-3 xl:p-4 rounded-xl shadow-md border border-slate-100 items-center space-x-4 w-52 xl:w-64">
            ...
            <div className="absolute top-64 xl:top-80 -right-6 xl:-right-8 bg-white p-3 xl:p-4 rounded-xl shadow-md border border-slate-100 flex items-center justify-between space-x-4 w-[280px] xl:w-80">
            ...
            <div className="absolute top-[23.1rem] xl:top-[30rem] 2xl:top-[34rem] -left-2 xl:-left-8 bg-white pl-8 xl:pl-10 py-3 xl:py-4 rounded-xl shadow-md border border-slate-100 flex items-center space-x-4 w-[260px] xl:w-72">
